...
class UpdateProductRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'shelves.array' => 'The shelves must be an array.',
            'shelves.max' => 'A product can only be assigned to one shelf at a time.',
            'shelves.*.exists' => 'The selected shelf does not exist.',
            ...
            'keep_images.*.exists' => 'Invalid image selected to keep.',
        ];
    }
